...
// The stock "Library" tab of `trivena.ui.FileUploader` browses framework File
...
;(async () => {
  await trivena.require('file_uploader.bundle.js')
  const Original = trivena.ui.FileUploader
  ...
  trivena.ui.FileUploader = DriveFileUploader
