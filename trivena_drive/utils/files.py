...
from trivena_drive.locks.distributed_lock import DistributedLock
...
class FileManager:
    def __init__(self):
        ...
        self.site_folder = Path(trivena.get_site_path())

        TEAMS = trivena.get_all("Drive Team", fields=["name", "s3_bucket", "prefix"])
    ...
    def upload_thumbnail(self, file, file_path: str):
        ...
        try:
            ...
            trivena.log_error("Thumbnail failed", e)
            if self.s3_enabled:
                try:
                    os.remove(file_path)
    ...
    def get_disk_path(self, entity, root: dict = None, embed=False):
        ...
        if self.flat:
            ...
            parent = (
                Path(storage_key(trivena.get_value("File", entity.folder, "file_url") or ""))
    ...
    def get_file(self, entity, range_header=None, log=True):
        ...
        try:
            ...
            if log:
                trivena.log_error("Drive: could not read file", e)
            trivena.throw("Could not find this file.", trivena.DoesNotExistError)
    ...
    def get_thumbnail(self, team, name):
        return self.get_file(
            trivena._dict({"team": team, "file_url": str(self.get_thumbnail_path(team, name))}), log=False
        )
    ...
    def move_to_trash(self, entity):
        ...
        try:
            ...
            trivena.log_error(f"Moved {entity.name} to trash without it being on disk")
            pass
    ...
    def restore(self, entity):
        ...
        """
        self.move(trivena._dict(file_url=self.__get_trash_path(entity), team=entity.team), entity.file_url)
    ...
    def move(self, entity, new_path: str | Path):
        ...
        try:
            ...
            trivena.throw("This file doesn't exist on disk.")
        return new_path
